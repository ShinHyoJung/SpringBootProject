...
<form class="ui form" style="width: 30%">
    ...
    <button class="ui button" type="button" onclick="find()">아이디 찾기</button>
</form>
        ...
        $.ajax({
            ...
            success: function (pageResponse) {
                if(pageResponse.code == 'SUCCESS') {
                    ...
                    $.ajax({
                        url:'${pageContext.request.contextPath}/member/id/find',
                        method: 'post',
                        dataType: 'json',
                        data: JSON.stringify(postObj),
                        contentType: 'application/json; charset=utf-8',
                        success: function(pageResponse) {
                            ...
                            if(pageResponse.code == 'SUCCESS') {
                                location.href = '${pageContext.request.contextPath}/member/id/found?loginID=' + pageResponse.loginID;
                            }
                        }
                    });
                }
